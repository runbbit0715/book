...
import { contnets, info, memos } from '../../data/books/storyofmoneyandaccounting'
import Main from '../../components/section/Main'

const StoryOfMoneyAndAccounting = () => {
  // 페이지 맨 위로 이동 함수
  const scrollToTop = () => {
    window.scrollTo({
      top: 0,
  ...
  return (
    <Main title='돈의 흐름이 보이는 회계 이야기 독서노트' description='구상수의 돈의 흐름이 보이는 회계 이야기를 읽고 정리한 독서노트입니다.'>
...
export default StoryOfMoneyAndAccounting